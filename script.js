/* ═══════════════════════════════════════════════════════════════
   Auktivo Landing Page – Interactive Logic
...
(function () {
  ...
  function initROICalculator() {
    ...
    /*
       * Schätzung: Durchschnittlicher manueller Aufwand pro Zwangsversteigerungsgutachten
       * (laut Produktbeschreibung: 1,5–3 Stunden = 90–180 Minuten).
       * Mit Auktivo reduziert auf ~8 Minuten (Mitte von 5–10 Min.).
       * Angenommener Stundensatz: 50 €/h (marktüblicher Mittelwert Selbstständige / Investoren DE).
       * employees = Objekte pro Monat, requests = manueller Aufwand pro Objekt in Minuten.
       */
      var objects       = employees;
      var manualMinutes = requests;
      var minutesSaved  = (manualMinutes - 8) * objects * 12;  // annual
  ...
  window.submitContactForm = function (e) {
    ...
    var mailSubject = encodeURIComponent(
      'Auktivo Anfrage' + (company.trim() ? ' \u2013 ' + company.trim() : '') + ': ' + subject
    );
    var mailBody = encodeURIComponent(
      'Beratungsanfrage \u00fcber Auktivo Landing Page\n' +
      '\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\n' +
      'Name:         ' + name.trim() + '\n' +
      'E-Mail:       ' + email.trim() + '\n' +
    ...
    window.open('mailto:info@wamocon.com?subject=' + mailSubject + '&body=' + mailBody);
    window.closeContactModal();
  };
